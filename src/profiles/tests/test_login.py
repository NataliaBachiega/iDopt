...
class LoginTestCase(APITestCase):
    ...
    def test_login(self):
        ...
        self.assertIsInstance(response.data['user'], dict, msg=json.dumps(response.data['user'], indent=4))
        self.assertIsInstance(response.data['device'], dict, msg=json.dumps(response.data['device'], indent=4))